...
<Prose>
  ...
  <dl>
    <dt>Stimulus</dt>
    <dd>37signalsが開発したJavaScriptフレームワーク。Stimulusは[MITライセンス](https://opensource.org/licenses/mit)でライセンスされています。ソースコードや詳細情報は、[StimulusのGitHubリポジトリ](https://github.com/hotwired/stimulus)で確認できます。</dd>
  </dl>
